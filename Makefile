CC = pgcc
CFLAGS = -acc -ta=tesla:managed -ta=multicore -Minfo=accel,loop,mp,opt,par
DEBUG = -g
LIBS = -lm
OPT = -fast
MAXKMERLENGTH=31
...
BUNDLEDZLIB=1
OPENMP=1
DEF = -D MAXKMERLENGTH=$(MAXKMERLENGTH) -D CATEGORIES=$(CATEGORIES) -D BIGASSEMBLY=$(BIGASSEMBLY) -D LONGSEQUENCES=$(LONGSEQUENCES) -D BUNDLEDZLIB=$(BUNDLEDZLIB) -D OPENMP=$(OPENMP)
